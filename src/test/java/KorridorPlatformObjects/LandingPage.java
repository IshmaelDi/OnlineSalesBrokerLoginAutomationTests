...
public class LandingPage extends PageObject{
    ...
    public void TMSLogo()throws InterruptedException {
        Thread.sleep(5000);
    ...
    public void ClicksOnTenantAndSelectDemoFromDropList(String Tenants) throws InterruptedException {
        Thread.sleep(1000);

        WebElement dropdown = $(By.xpath(Tenant));
        Select selectObject = new Select(dropdown);
        selectObject.selectByValue(Tenants);
    }

    @Step("Click on Principal And Select AutoDemo From Drop List")
    public void ClickonPrincipalAndSelectAutoDemoFromDropList(String Principals) throws InterruptedException {
        Thread.sleep(1000);

        WebElement dropdown2 = $(By.xpath(Principal));
        Select selectObject = new Select(dropdown2);
        selectObject.selectByValue(Principals);
    }
